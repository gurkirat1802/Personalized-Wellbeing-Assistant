...
const LosePage = () => {
    ...
    const mildLossCalories = maintenanceCalories * 0.87;
    const lossCalories = maintenanceCalories * 0.73;
    const extremeLossCalories = maintenanceCalories * 0.47;
    // console.log("mildloss" + mildLossCalories.toFixed(0));
    // console.log("loss" + lossCalories.toFixed(0));
    // console.log("extloss" + extremeLossCalories.toFixed(0));
    const calorieNeeded = lossCalories;
    // console.log("needed" + calorieNeeded.toFixed(1));
    ...
    const targetCalories = lossCalories.toFixed(0);
    ...
    return (
        <>
            <section>
                ...
                <p className="text-2xl text-justify font-medium px-10 mt-5">According to your height your ideal weight should be {idealWeight.toFixed(2)} kg. If you want to lose weight your daily calorie consumption should not be more than {mildLossCalories.toFixed(0)}kcal. Let's take steps together to make you healthy and lose your weight. Here is the data showing calorie consumption for you to lose weight.</p>
                <p className="text-2xl text-justify font-medium px-10 mt-5">BMR: {bmr}kcal <br /> Maintainence Calories: {maintenanceCalories}kcal <br /> Mild Loss Calories: {mildLossCalories.toFixed(0)}kcal <br /> Loss Calories: {lossCalories.toFixed(0)}kcal <br /> Extreme Loss Calories: {extremeLossCalories.toFixed(0)}kcal</p>
                <div className="flex">
                    <p className="text-2xl text-justify font-medium px-5 mt-6 ml-5">Here is a basic workout plan to lose fat.</p>
                    <Link to="../components/Fatloss" target="_top">
                        <button type="button" className="mt-5 font-semibold text-lg bg-green-500 px-5 py-2 rounded-xl hover:bg-green-400 w-48">FATLOSS PLAN</button>
                    </Link>
                </div>
                <div className="flex">
