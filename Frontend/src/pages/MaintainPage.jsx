...
const MaintainPage = () => {
    ...
    // console.log("needed" + maintenanceCalories);
    const calculateCarbsNeeded = () => {
        if (!maintenanceCalories) {
            alert('Please enter total daily calories.');
            return;
        }
        const carbsCalories = maintenanceCalories * 0.50;
    ...
    return (
        <>
            <section>
                ...
                <p className="text-2xl text-justify font-medium px-10 mt-5">According to your height your ideal weight should be {idealWeight.toFixed(2)} kg. If you want to maintain your weight your daily calorie consumption should be {maintenanceCalories.toFixed(0)}kcal. Let's take steps together to maintain your healthy lifestyle. Here is the data showing calorie consumption for you to maintain your weight.</p>
                <p className="text-2xl text-justify font-medium px-10 mt-5">BMR: {bmr}kcal <br /> Maintainence Calories: {maintenanceCalories}kcal</p>
                <div className="flex">
